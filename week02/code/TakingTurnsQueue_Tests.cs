...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: FIFO is not being followed. Error in PersonQueue.cs
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim is not entered back into the queue. GetNextPerson logic error. No case for what to do if person is given 0 turns (forever).
    ...
    // Defect(s) Found: No case to handle infinite turns in GetNextPerson.
